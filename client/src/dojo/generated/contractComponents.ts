...
export function defineContractComponents(world: World) {
  return {
    ...
    ActiveMission: (() => {
      return defineComponent(
        world,
        { planet_id: RecsType.Number, mission_id: RecsType.Number, mission: { id: RecsType.Number, time_start: RecsType.Number, origin: RecsType.Number, destination: RecsType.Number, time_arrival: RecsType.Number, fleet: { carrier: RecsType.Number, scraper: RecsType.Number, sparrow: RecsType.Number, frigate: RecsType.Number, armade: RecsType.Number }, category: RecsType.Number } },
        {
          metadata: {
            name: "ActiveMission",
            types: ["u32","usize","u32","u64","u32","u32","u64","u32","u32","u32","u32","u32","u8"],
